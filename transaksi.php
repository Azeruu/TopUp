                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary" href="./transaksi/edit.php?id=<?php echo $idtransaksi ?>" >Edit</a> <a class="btn btn-danger" href="./transaksi/hapus.php?id=<?php echo $idtransaksi ?>">Hapus</a>
