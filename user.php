        ...
        <div id="layoutSidenav_content">
            ...
            <table class="table table-bordered" id="datatablesSimple" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                $ambilsemuadata = mysqli_query($conn, "SELECT*FROM tbl_user;");
                                $i = 1;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary" href="./user/edit.php?id=<?= $iduser ?>">Edit </a> <a class="btn btn-danger" href="./user/hapus.php?id=<?php echo $iduser ?>">Hapus</a></td>
                                    </tr>
                                <?php
                                }
                                ?>
